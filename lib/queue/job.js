...
/**
 * Emit an custom message on the job
 *
 * @param {String} event a custom event-key
 * @param {Object} msg any objct
 * @returns {Job} for chaining
 */
Job.prototype.sendMessage = function(event, msg) {
  events.emit(this.id, event, msg);
  return this;
};
